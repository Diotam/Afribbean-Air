...
export default function AfribbeanAirLanding() {
  ...
  useEffect(() => {
    document.title =
      "Afribbean Air — Directly Connecting the Caribbean, Africa & South America";
  ...
  return (
    <div className="min-h-screen text-slate-900 bg-white relative overflow-x-hidden">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mt-4 flex items-center justify-between rounded-2xl bg-white/70 backdrop-blur supports-[backdrop-filter]:bg-white/60 border border-white/40 shadow-sm p-2 pl-3">
            <a href="#home" className="flex items-center gap-3">
              <img
                src={logoSrc}
                alt="Afribbean Air logo"
                className="h-10 w-10 rounded-full ring-2 ring-emerald-500/30 bg-white object-contain"
                onError={(e) => {
            ...
            <nav className="hidden md:flex items-center gap-6 text-sm font-medium text-slate-700">
              ...
              <a href="#solution" className="hover:text-emerald-700">
                Benefits
              </a>
              <a href="#network" className="hover:text-emerald-700">
                Network
              </a>
              <a href="#experience" className="hover:text-emerald-700">
                Experience
              </a>
            </nav>
      ...
      <main className="snap-y snap-mandatory">
          ...
          <div className="mx-auto grid max-w-7xl gap-10 px-4 sm:px-6 lg:grid-cols-2 lg:items-center lg:gap-16 lg:px-8 pt-32 pb-20">
            ...
            >
              ...
              <p className="mt-5 text-lg leading-relaxed text-slate-700">
                ...
                together with efficient, sustainable,{" "}
                <strong>direct routes</strong> that turn long detours into
                same‑day journeys.
              </p>
              <div className="mt-8 flex flex-wrap items-center gap-3">
                <a
                  href="#waitlist"
                  className="inline-flex items-center justify-center gap-2 rounded-2xl bg-emerald-600 px-5 py-3 text-white font-semibold shadow hover:bg-emerald-700"
                >
                  Get Early Access <ArrowRight className="size-4" />
                </a>
                <a
                  href="#network"
                  className="inline-flex items-center justify-center gap-2 rounded-2xl bg-white px-5 py-3 text-emerald-700 font-semibold ring-1 ring-emerald-200 hover:bg-emerald-50"
                >
                  See Route Vision
                </a>
              </div>
        ...
        <section
          id="problem"
          className="snap-start min-h-screen flex items-center bg-white/70"
        >
            ...
            >
              <div className="max-w-2xl">
                ...
                <p className="mt-4 text-slate-700 text-lg">
                  ...
                  connections through the US or Europe, creating cost, visa, and
                  time barriers.
                </p>
              </div>
              ...
              <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                <ProblemCard
                  ...
                  title="Lost time"
                >
                  Up to <strong>10–24 hours</strong> added from multi‑stop
                  itineraries and overnight layovers.
                </ProblemCard>
                <ProblemCard
                  icon={<ShieldAlert className="size-5" />}
                  title="Transit visa hurdles"
                >
                  Many travelers need <strong>extra visas</strong> to simply
                  change planes in the US/EU, blocking trips entirely.
                </ProblemCard>
                <ProblemCard
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-24 w-full">
            ...
            >
              ...
              <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                <BenefitCard
                  icon={<Clock className="size-5" />}
                  title="Faster door‑to‑door"
                >
                  Save <strong>6–12+ hours</strong> vs. detours. Same‑day
                  arrivals for business, family, and events.
                </BenefitCard>
                <BenefitCard
                  icon={<ShieldAlert className="size-5" />}
                  title="Simpler travel"
                >
                  Avoid common <strong>transit‑visa</strong> requirements, fewer
                  touchpoints, and stress‑free connections.
                </BenefitCard>
                <BenefitCard
                  icon={<Wallet className="size-5" />}
                ...
                <BenefitCard
                  ...
                  title="Seamless sea‑air logistics"
                >
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-24 w-full">
            ...
            >
              <div className="max-w-3xl">
                ...
                <p className="mt-4 text-slate-700 text-lg">
                  Illustrative nonstop links to collapse travel times and open
                  new markets. Final network subject to regulatory approvals and
                  demand.
                </p>
              </div>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-24 w-full">
            ...
            >
              <div className="max-w-3xl">
                ...
                <p className="mt-4 text-slate-700 text-lg">
                  Spacious cabins, Caribbean hospitality, and regionally curated
                  meals keep the journey fresh and productive.
                </p>
              </div>

              <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                <FeatureCard title="A220/A321 interiors">
                  Wider seats, larger windows, lower noise and modern mood
                  lighting.
                </FeatureCard>
                <FeatureCard title="Wi‑Fi + power at every seat">
                  Stream, work, and call home with gate‑to‑gate connectivity.
                </FeatureCard>
                <FeatureCard title="Tropical cuisine & wellness">
                  Hydrating menus, Caribbean flavors, and stretch‑friendly
                  service flows.
                </FeatureCard>
              </div>
            </motion.div>
        ...
        <section id="waitlist" className="snap-start">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-24">
            <motion.div
              ...
              whileInView="show"
              viewport={{ once: true, amount: 0.2 }}
              className="rounded-3xl border border-emerald-200 bg-white/80 p-10 shadow-sm"
            >
              <div className="grid lg:grid-cols-3 gap-8 items-center">
                <div className="lg:col-span-2">
                  ...
                  <p className="mt-2 text-slate-700">
                    Join the insider list for launch routes, fares, and
                    partnerships.
                  </p>
                  <form
                  ...
                  >
                    <input
                      ...
                      className="w-full rounded-xl border border-slate-300 bg-white px-4 py-3 text-slate-900 focus:outline-none focus:ring-2 focus:ring-emerald-500"
                    />
                ...
                <div className="flex items-center justify-center">
                  <img
                    src={logoSrc}
                    alt="Afribbean Air logo"
                    className="h-36 w-36 rounded-full ring-4 ring-emerald-500/30 bg-white object-contain"
                    onError={(e) => {
                      e.currentTarget.style.display = "none";
                    }}
                  />
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10 flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-3">
            <img
              src={logoSrc}
              alt="Afribbean Air logo"
              className="h-8 w-8 rounded-full ring-2 ring-emerald-500/30 bg-white object-contain"
              onError={(e) => {
                e.currentTarget.style.display = "none";
              }}
            />
            <span className="text-sm font-semibold">
              © {new Date().getFullYear()} Afribbean Air
            </span>
          </div>
          <div className="text-sm text-slate-600">
            Made for the Atlantic tropics • Privacy • Careers • Partnerships
          </div>
        </div>
      </footer>
    </div>
...
function RouteRow({ from, to, time, note }) {
  return (
    <div className="flex items-start gap-3 rounded-2xl border border-slate-200 bg-white/70 p-4">
      <div className="mt-1 inline-flex h-9 w-9 items-center justify-center rounded-xl bg-cyan-50 text-cyan-700 ring-1 ring-cyan-200">
  ...
  return (
    <ul className="mt-8 grid grid-cols-2 sm:grid-cols-4 gap-3">
      {items.map((it, i) => (
        <li
          key={i}
          className="flex items-center gap-2 rounded-xl bg-white/70 px-3 py-2 text-sm ring-1 ring-slate-200"
        >
...
function WorldRoutesSVG({ emphasis = false }) {
  ...
  return (
    <svg
      viewBox="0 0 800 480"
      role="img"
      aria-label="Outline map with route lines"
      className="w-full h-[360px] md:h-[460px] rounded-3xl border border-slate-200 bg-white/60 shadow-sm"
    >
      <defs>
      ...
      <RouteArc
        d="M300,190 C380,150 470,170 540,240"
        delay={0}
        strokeRef={routeRef}
      />
      <RouteArc
        d="M250,260 C350,200 450,220 520,260"
        delay={0.2}
        strokeRef={routeRef}
      />
      <RouteArc
        d="M340,200 C420,170 500,190 560,260"
        delay={0.4}
        strokeRef={routeRef}
      />
      <RouteArc
        d="M280,210 C380,150 460,160 500,220"
        delay={0.6}
        strokeRef={routeRef}
      />
    </svg>
...
function NoiseOverlay() {
  return (
    <svg
      className="absolute inset-0 w-full h-full opacity-[.06]"
      aria-hidden="true"
    >
      <filter id="n" x="0" y="0">
        <feTurbulence
  ...
  return (
    <svg className="absolute inset-0 w-full h-full" aria-hidden="true">
      ...
      {Array.from({ length: 6 }).map((_, i) => (
        <g
          key={i}
          transform={`translate(${i % 2 ? 80 : -40},${i * 120 - 60}) rotate(${
            i % 2 ? 20 : -15
          })`}
          opacity="0.22"
        >
          {[...Array(8)].map((__, j) => (
            <path
              key={j}
              d={`M${j * 22},0 C${j * 22 + 4},20 ${j * 22 + 10},40 ${
                j * 22 + 16
              },60`}
              stroke="url(#leaf)"
              strokeWidth="10"
